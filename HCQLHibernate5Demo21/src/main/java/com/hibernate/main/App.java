...
public class App {
	public static void main(String[] args) {
		...
		criteriaQuery.multiselect(criteriaBuilder.count(root.get("name")), criteriaBuilder.sum(root.get("salary")),
				root.get("department"));
		criteriaQuery.groupBy(root.get("department"));
		criteriaQuery.having(criteriaBuilder.greaterThan(criteriaBuilder.sum(root.get("salary")), 20000));
