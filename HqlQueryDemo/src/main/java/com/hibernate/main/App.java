...
public class App {
	...
	public static void main(String[] args) {
		...
		employee.setSalary(20000.443);
		
		address.setAddressLine1("Prem Nagar");
		address.setCity("Ropar");
		address.setZipcode("144533");
...
//		//HQL join examples
//				Query query = session.createQuery("select e.name, a.city from Employee as e "
