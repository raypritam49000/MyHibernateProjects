...
public class Marks {
	...
	public int getPunjabi_marks() {
		return punjabi_marks;
	}

	public void setPunjabi_marks(int punjabi_marks) {
		this.punjabi_marks = punjabi_marks;
	}
